        ...
        */
        _create: function () {
            ...
            this._styles = [
                ...
                '.js-ready #' + this.options.offCanvasContainerId + '{ left: -70%; height: 100%; width: 70%; -webkit-box-shadow: inset -1.5em 0 1.5em -0.75em rgba(0, 0, 0, 0.25); -moz-box-shadow: inset -1.5em 0 1.5em -0.75em rgba(0, 0, 0, 0.25); box-shadow: inset -1.5em 0 1.5em -0.75em rgba(0, 0, 0, 0.25); }',
